    ...
    <section className="section-spacing bg-background border-t border-border/50">
      <div className="container-flow text-center px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl text-foreground/80 mb-10 sm:mb-12 md:mb-16 max-w-2xl mx-auto px-4">
            Real brands. Real results. Real predictability.
          </p>

          {/* Blurred Brand Logos */}
          <div className="mb-10 sm:mb-12 md:mb-16 flex justify-center items-center gap-4 sm:gap-6 md:gap-8 px-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
